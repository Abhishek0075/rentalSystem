...
public class ownerSignin extends javax.swing.JFrame {
     ...
     */
    public ownerSignin(Connection conn){
        mdbConnection=conn;
        initComponents();
    }
    /**
    ...
    private void signUpButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_signUpButtonActionPerformed
        // TODO add your handling code here:
        dispose();     
        new ownSignup(mdbConnection).setVisible(true);
...
//        userSelector connCaller=new userSelector();
//        Connection mdbConnection=connCaller.createConnection();
//        
//        java.awt.EventQueue.invokeLater(new Runnable(){
//            public void run() {
//                new ownerSignin(mdbConnection).setVisible(true);
//            }
//        });
//    }
