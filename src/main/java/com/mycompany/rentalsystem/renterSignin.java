 ...
 * @author abhir
 */
public class renterSignin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("RENTER SIGN IN");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(renterSignin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new renterSignin().setVisible(true);
            }
        });
    }
